...
MNETV2_CONFIGS_MAP = {
    (224,224):{
        ...
        'bottleneck_params_list':[
            (1, 32, 1, 1), # 32x112x112 -> 16x112x112
            (6, 48, 2, 2), # 16x112x112 -> 24x56x56
            (6, 64, 3, 2), # 24x56x56 -> 32x28x28
            (6, 128, 4, 2), # 32x28x28 -> 64x14x14
            (6, 192, 3, 1), # 64x14x14 -> 96x14x14
            (6, 320, 3, 2), # 96x14x14 -> 160x7x7
            (6, 640, 1, 1), # 160x7x7 -> 320x7x7
        ],
