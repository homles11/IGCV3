...
if __name__ == '__main__':
    ...
    if not os.path.exists(im2rec_path):
        # im2rec_path = "D:\\v-mingjl\\mxnet-ssd-master\\tools\\im2rec.py"
    ...
    subprocess.check_call(["python", im2rec_path,
        os.path.abspath(args.target), os.path.abspath(args.root_path)])#, "--pack-label=1","--shuffle="+str(int(args.shuffle))
